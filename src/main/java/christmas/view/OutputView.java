...
public class OutputView {
    ...
    public static void printOrderedMenu(Order order) {
        ...
        order.orderedFoods().forEach(food -> System.out.println(food.getName() + " " + food.getQuantity() + "개"));
        System.out.println();
    }
    ...
    public static void printGiftMenu(Optional<GiftMenu> giftMenu) {
        ...
        giftMenu.ifPresentOrElse(
                menu -> System.out.println(menu.getGiftName() + " " + menu.getGiftCount() + "개"),
                () -> System.out.println("없음")
        );
        System.out.println();
    }

    public static void printBenefits(Map<String, Integer> discountBenefits, Optional<GiftMenu> giftMenu) {
        System.out.println(DISCOUNT_BENEFITS_HEADER);

        if (discountBenefits.isEmpty() && giftMenu.isEmpty()) {
            System.out.println("없음");
        }
        ...
        giftMenu.ifPresent(menu ->
                System.out.println(menu.getGiftName() + ": -" + String.format("%,d원", menu.getPrice()))
        );
